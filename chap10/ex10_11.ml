...
let rec get_ekikan_kyori_exsample eki1 eki2 lst = match lst with 
    [] -> infinity 
...
(* テスト *) 
let test1_exsample = get_ekikan_kyori_exsample "茗荷谷" "新大塚" global_ekikan_list = 1.2 
let test2_exsample = get_ekikan_kyori_exsample "茗荷谷" "池袋" global_ekikan_list = infinity 
let test3_exsample = get_ekikan_kyori_exsample "東京" "大手町" global_ekikan_list = 0.6 
